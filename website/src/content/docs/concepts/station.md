...
A `Station` is the **runtime template**. It pairs one [AgentDefinition](./agentdefinition.md)
...
[Agent runtime](./agent-runtime.md) for details.

The full field reference is in [Station CRD](../reference/crd-station.md).
