...
See [How the pieces relate](/ai-agent-subsystem/concepts/relationships/) for the full schema, or jump
to the [Architecture](/ai-agent-subsystem/concepts/architecture/) for the component design.
