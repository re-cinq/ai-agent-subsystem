...
<CardGrid>
	...
	<LinkCard title="Architecture" href="/ai-agent-subsystem/concepts/architecture/" description="The D monorepo: two binaries and a shared library, statically linked." />
